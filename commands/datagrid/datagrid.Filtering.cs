...
public partial class CustomGUIs
{
    ...
    private static FilterGroup ParseFilterGroup(string groupText)
    {
        ...
        // Split into tokens - updated regex to handle 'e' prefix for exact matching and general quoted exclusions
        List<string> tokens = Regex.Matches(
                groupText,
                @"(!\d+\$e""[^""]+?""::e""[^""]+?""|!\d+\$e""[^""]+?""::[^ ]+|!\d+\$[^ ]+?::e""[^""]+?""|!\d+\$e""[^""]+?""::""[^""]+?""|!\d+\$""[^""]+?""::e""[^""]+?""|!\d+\$e""[^""]+?""|!\d+\$""[^""]+?""::""[^""]+?""|!\d+\$""[^""]+?""\:\:[^ ]+|!\d+\$[^ ]+?::""[^""]+?""|!\d+\$[^ ]+?::[^ ]+|!\d+\$""[^""]+?""\:[^ ]+|!\d+\$[^ ]+?:[^ ]+|!\d+\$""[^""]+?""|!\d+\$[^ ]+|\d+\$e""[^""]+?""::e""[^""]+?""|\d+\$e""[^""]+?""::[^ ]+|\d+\$[^ ]+?::e""[^""]+?""|\d+\$e""[^""]+?""::""[^""]+?""|\d+\$""[^""]+?""::e""[^""]+?""|\d+\$e""[^""]+?""|\d+\$""[^""]+?""::""[^""]+?""|\d+\$""[^""]+?""\:\:[^ ]+|\d+\$[^ ]+?::""[^""]+?""|\d+\$[^ ]+?::[^ ]+|\d+\$""[^""]+?""\:[^ ]+|\d+\$[^ ]+?:[^ ]+|\d+\$""[^""]+?""|\d+\$[^ ]+|!\$e""[^""]+?""::e""[^""]+?""|!\$e""[^""]+?""::[^ ]+|!\$[^ ]+?::e""[^""]+?""|!\$e""[^""]+?""::""[^""]+?""|!\$""[^""]+?""::e""[^""]+?""|!\$e""[^""]+?""|!\$""[^""]+?""::""[^""]+?""|!\$""[^""]+?""\:\:[^ ]+|!\$[^ ]+?::""[^""]+?""|!\$[^ ]+?::[^ ]+|!\$""[^""]+?""\:[^ ]+|!\$[^ ]+?:[^ ]+|!\$""[^""]+?""|!\$[^ ]+|\$e""[^""]+?""::e""[^""]+?""|\$e""[^""]+?""::[^ ]+|\$[^ ]+?::e""[^""]+?""|\$e""[^""]+?""::""[^""]+?""|\$""[^""]+?""::e""[^""]+?""|\$e""[^""]+?""|\$""[^""]+?""::""[^""]+?""|\$""[^""]+?""\:\:[^ ]+|\$[^ ]+?::""[^""]+?""|\$[^ ]+?::[^ ]+|\$""[^""]+?""\:[^ ]+|\$[^ ]+?:[^ ]+|\$""[^""]+?""|\$[^ ]+|[<>]\d+\.?\d*|!e""[^""]+?""|!""[^""]+?""|e""[^""]+?""|""[^""]+""|\S+)")
            .Cast<Match>()
