...
(defun c:sca () (command "select-by-categories-in-session") (princ))
;; (defun c:slv () (command "select-by-layers-in-view") (princ))
;; (defun c:sld () (command "select-by-layers-in-document") (princ))
;; (defun c:sla () (command "select-by-layers-in-session") (princ))
(defun c:slv () (command "select-similar-by-layer-in-view") (princ))
(defun c:sld () (command "select-similar-by-layer-in-document") (princ))
(defun c:sla () (command "select-similar-by-layer-in-session") (princ))
(defun c:fv () (command "filter-selection-in-view") (princ))
(defun c:fd () (command "filter-selection-in-document") (princ))
(defun c:fa () (command "filter-selection-in-session") (princ))
...
(defun c:eta () (command "edit-selected-text-in-session") (princ))
