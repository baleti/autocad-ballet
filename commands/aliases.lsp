...
(defun c:sl () (command "select-by-same-layers-of-selected-in-view") (princ))
(defun c:slv () (command "select-by-same-layers-of-selected-in-view") (princ))
(defun c:sld () (command "select-by-same-layers-of-selected-in-document") (princ))
(defun c:sls () (command "select-by-same-layers-of-selected-in-session") (princ))
